...
then
    ...
    python2 upload_race.py --file uvm-2025.txt --delim ";" --race-name "Utah Valley Half Marathon"  --race-date 2025-06-07 --race-dist-cm 2109750
    python2 upload_race.py --file salt-city-mile-2025.txt --delim ";" --race-name "Salt City Mile"  --race-date 2025-06-14 --race-dist-cm 160934
fi
...
python2 upload_race.py --file tou-half-2025.txt --delim ";" --race-name "Top of Utah Half Marathon"  --race-date 2025-08-23 --race-dist-cm 2109750
