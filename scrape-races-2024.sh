#! /bin/bash
#python2 scrape_runsignup.py --race-id=49207 --result-set-id=435287 > slctrack-5k-2024.txt
#python2 scrape_runsignup.py --race-id=49207 --result-set-id=436907 > stctrack-10k-2024.txt
...
#python2 scrape_webscorer.py --race-id=350897 > may-4th-5k-2024.txt
...
#python2 scrape_runsum.py --race-id=616 --event="Half Marathon" > uvm-2024.txt
